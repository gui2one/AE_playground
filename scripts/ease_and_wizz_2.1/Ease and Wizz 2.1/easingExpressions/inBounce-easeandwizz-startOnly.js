// Ease and Wizz 2.1 : inBounce : First two keyframes only
...
function easeAndWizz() {
	...
	if ((time < key1.time) || (time > key2.time)) {
		...
		val1 = easeandwizz_inBounce(t, sX, eX, d, a, p, s);
		switch (dim) {
			case 1:
			     return val1;
			     break;
			case 2:
			     val2 = easeandwizz_inBounce(t, sY, eY, d, a, p, s);
			     return [val1, val2];
			     break;
			case 3:
			     val2 = easeandwizz_inBounce(t, sY, eY, d, a, p, s);
			     val3 = easeandwizz_inBounce(t, sZ, eZ, d, a, p, s);
